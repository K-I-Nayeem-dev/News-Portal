...
<body>
                    ...
                    <div id="headerNav" class="navbar-collapse collapse float--left">
                        <ul class="header--menu-links nav navbar-nav" data-trigger="hoverIntent">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Home
                                            Versions<i class="fa flm fa-angle-right"></i></a>
                                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown megamenu filter">
                                <a href="world-news.html" class="dropdown-toggle" data-toggle="dropdown">Worlds
                                    News<i class="fa flm fa-angle-down"></i></a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <div class="row">
                                            <div class="col-md-2">
                                                ...
                                                <div class="megamenu--posts" data-ajax-content="outer">
                                                    <ul class="row" data-ajax-content="inner">
                                                        <li class="col-md-3">
                                                            <div class="img">
                                                                <a href="news-single-v1.html" class="thumb">
                                                                    <img src="{{ asset('frontend_assets') }}/img/megamenu-img/post-01.jpg"
                                                                        alt="" />
                                                                </a>
                                                        ...
                                                        <li class="col-md-3">
                                                            <div class="img">
                                                                <a href="news-single-v1.html" class="thumb">
                                                                    <img src="{{ asset('frontend_assets') }}/img/megamenu-img/post-02.jpg"
                                                                        alt="" />
                                                                </a>
                                                        ...
                                                        <li class="col-md-3">
                                                            <div class="img">
                                                                <a href="news-single-v1.html" class="thumb">
                                                                    <img src="{{ asset('frontend_assets') }}/img/megamenu-img/post-03.jpg"
                                                                        alt="" />
                                                                </a>
                                                        ...
                                                        <li class="col-md-3">
                                                            <div class="img">
                                                                <a href="news-single-v1.html" class="thumb">
                                                                    <img src="{{ asset('frontend_assets') }}/img/megamenu-img/post-04.jpg"
                                                                        alt="" />
                                                                </a>
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        ...
                                        <div class="megamenu--pagination" data-ajax="tab">
                                            ...
                                            <a href="travel.html" class="all" title="View All"
                                                data-toggle="tooltip">
                                                <i class="fa fa-th-large"></i>
                                            </a>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">News
                                            Single<i class="fa flm fa-angle-right"></i></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle"
                                            data-toggle="dropdown">Contributors<i
                                                class="fa flm fa-angle-right"></i></a>
                                        <ul class="dropdown-menu">
    ...
    <div id="stickySocial" class="sticky--right">
        <ul class="nav">
            ...
            <li>
                <a href="#">
                    <i class="fa-brands fa-x-twitter"></i> <span style="color: white; background-color: black"">Follow Us On Twitter</span>
                </a>
            </li>
            <li>
                <a href="#">
