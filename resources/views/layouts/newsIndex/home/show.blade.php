                        ...
                        <div class="post--item post--single post--title-largest pd--30-0">
                            ...
                            <div class="post--info">
                                <ul class="nav meta">
                                    ...
                                    <li>{{ session()->get('lang') == 'english' ? $news->title_en : $news->title_bn }}</li>
                                    <li>
                                ...
                                <div class="title">
                                    <h2 class="h4">
                                        {{ session()->get('lang') == 'english' ? $news->created_at->format('j F Y')  : formatBanglaDate($news->created_at) }}
                                    </h2>
                                </div>
                            </div>
                            <div class="post--content">
                                <p>
                                    ...
                                    free from repetition words etc.
                                </p>
                                ...
                                <blockquote>
                                    <p>
                                        ...
                                        that it has a more-or-less normal making it look like
                            ...
                            <div class="info">
                                ...
                                <div class="content">
                                    <p>
                                        ...
                                        distracted by the readable content of a page when
                                        looking at its layout. The point of using Lorem Ipsum is
                                        that it has ab more normal distribution of letters, as
                                    ...
                                    <div class="post--item">
                                        <div class="post--img">
                                            ...
                                            <div class="post--info">
                                                ...
                                                <div class="title">
                                                    <h3 class="h4">
                                                        <a href="#" class="btn-link">On the other hand, we denounce
                                                            with righteous
                                            ...
                                            <div class="post--item post--layout-3">
                                                <div class="post--img">
                                                    ...
                                                    <div class="post--info">
                                                        ...
                                                        <div class="title">
                                                            <h3 class="h4">
                                                                <a href="#" class="btn-link">Long established fact
                                                                    that a reader will
                                                                    be distracted</a>
                                                            </h3>
                                                        </div>
                                    ...
                                    <ul class="nav" data-ajax-content="inner">
                                        ...
                                        <li>
                                            <div class="post--item post--layout-3">
                                                <div class="post--img">
                                                    <span class="thumb">
                                                        <img src="img/widgets-img/readers-opinion-02.png"
                                                            alt="" />
                                                    </span>
                                                    <div class="post--info">
                                                        <div class="title">
                                        ...
                                        <li>
                                            <div class="post--item post--layout-3">
                                                <div class="post--img">
                                                    <span class="thumb">
                                                        <img src="img/widgets-img/readers-opinion-03.png"
                                                            alt="" />
                                                    </span>
                                                    <div class="post--info">
                                                        <div class="title">
                                    ...
                                    <ul class="nav" data-ajax-content="inner">
                                        <li>
                                            <div class="post--item post--layout-3">
                                                <div class="post--img">
                                                    <a href="#" class="thumb"><img
                                                            src="img/widgets-img/editors-choice-01.jpg"
                                                            alt="" /></a>
                                                    <div class="post--info">
                                                        <ul class="nav meta">
                                                            <li><a href="#">Ninurta</a></li>
                                        ...
                                        <li>
                                            <div class="post--item post--layout-3">
                                                <div class="post--img">
                                                    <a href="#" class="thumb"><img
                                                            src="img/widgets-img/editors-choice-02.jpg"
                                                            alt="" /></a>
                                                    <div class="post--info">
                                                        <ul class="nav meta">
                                                            <li><a href="#">Orcus</a></li>
                                        ...
                                        <li>
                                            <div class="post--item post--layout-3">
                                                <div class="post--img">
                                                    <a href="#" class="thumb"><img
                                                            src="img/widgets-img/editors-choice-03.jpg"
                                                            alt="" /></a>
                                                    <div class="post--info">
                                                        <ul class="nav meta">
                                                            <li><a href="#">Rahab</a></li>
                                        ...
                                        <li>
                                            <div class="post--item post--layout-3">
                                                <div class="post--img">
                                                    <a href="#" class="thumb"><img
                                                            src="img/widgets-img/editors-choice-04.jpg"
                                                            alt="" /></a>
                                                    <div class="post--info">
                                                        <ul class="nav meta">
                                                            <li><a href="#">Tannin</a></li>
