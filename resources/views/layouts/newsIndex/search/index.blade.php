                        ...
                        <li class="news-item"
                            ...
                            <div class="news-image"
                                ...
                                <a
                                    ...
                                    @else
                                        <div
                                            style="width: 100%; height: 100%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); display: flex; align-items: center; justify-content: center; color: white; font-size: 18px;">
                                            @if (session()->get('lang') == 'english')
                                                No Image
                                            @else
                                                ছবি নেই
                            ...
                            <div class="news-content" style="flex: 1; display: flex; flex-direction: column;">
                                <div class="news-top">
                                    ...
                                    @if (session()->get('lang') == 'english')
                                        @if ($item->title_bn)
                                            <h4
                                                style="margin: 0 0 15px 0; font-size: 18px; font-weight: 500; color: #555; line-height: 1.4;">
                                                {{ $item->title_bn }}
                                            </h4>
                                        @endif
                                    @else
            ...
            @else
                <div style="background: #e3f2fd; border-left: 4px solid #2196f3; padding: 20px 25px; border-radius: 6px;">
                    ...
                    <p style="margin: 0; color: #555; font-size: 15px;">
                        @if (session()->get('lang') == 'english')
                            Try different keywords or browse our <a href="{{ route('home') }}"
                                style="color: #2196f3; text-decoration: none; font-weight: 500;">latest news</a>
                        @else
                            বিভিন্ন কীওয়ার্ড চেষ্টা করুন অথবা আমাদের <a href="{{ route('home') }}"
                                style="color: #2196f3; text-decoration: none; font-weight: 500;">সর্বশেষ সংবাদ</a> ব্রাউজ
                            করুন
                        @endif
                    </p>
                </div>
