              ...
              <div class="header--mainbar">
                <div class="container">
                  ...
                  <div class="header--ad float--right float--sm-none hidden-xs">
                    <a href="#">
                      <img src="{{ asset('frontend_assets') }}/img/ads-img/ad-728x90-01.jpg" alt="Advertisement" />
                    </a>
                  </div>
                </div>
              </div>
                    ...
                    >
                      <li class="dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                          >Home<i class="fa flm fa-angle-down"></i
                        ></a>
                        <ul class="dropdown-menu">
                          ...
                          <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                              >Home Versions<i class="fa flm fa-angle-right"></i
                            ></a>
                            <ul class="dropdown-menu">
                          ...
                          <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                              >Menu Versions<i class="fa flm fa-angle-right"></i
                            ></a>
                            <ul class="dropdown-menu">
                      ...
                      <li class="dropdown megamenu filter">
                        <a
                          href="world-news.html"
                          class="dropdown-toggle"
                          data-toggle="dropdown"
                          >Worlds News<i class="fa flm fa-angle-down"></i
                        ></a>
                        <ul class="dropdown-menu">
                          <li>
                            <div class="row">
                                  ...
                                  <ul class="row" data-ajax-content="inner">
                                    <li class="col-md-3">
                                      <div class="img">
                                        <a href="news-single-v1.html" class="thumb">
                                          <img
                                            src="{{ asset('frontend_assets') }}/img/megamenu-img/post-01.jpg"
                                            alt=""
                                          />
                                        </a>
                                      ...
                                      <a href="news-single-v1.html" class="title"
                                    ...
                                    <li class="col-md-3">
                                      <div class="img">
                                        <a href="news-single-v1.html" class="thumb">
                                          <img
                                            src="{{ asset('frontend_assets') }}/img/megamenu-img/post-02.jpg"
                                            alt=""
                                          />
                                        </a>
                                    ...
                                    <li class="col-md-3">
                                      <div class="img">
                                        <a href="news-single-v1.html" class="thumb">
                                          <img
                                            src="{{ asset('frontend_assets') }}/img/megamenu-img/post-03.jpg"
                                            alt=""
                                          />
                                        </a>
                                    ...
                                    <li class="col-md-3">
                                      <div class="img">
                                        <a href="news-single-v1.html" class="thumb">
                                          <img
                                            src="{{ asset('frontend_assets') }}/img/megamenu-img/post-04.jpg"
                                            alt=""
                                          />
                                        </a>
                      ...
                      <li class="dropdown megamenu posts">
                        <a
                          ...
                          class="dropdown-toggle"
                          data-toggle="dropdown"
                          >Travel<i class="fa flm fa-angle-down"></i
                        ></a>
                        <ul class="dropdown-menu">
                          <li>
                      ...
                      <li class="dropdown megamenu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                          >Catagory<i class="fa flm fa-angle-down"></i
                        ></a>
                        <ul class="dropdown-menu">
                          <li class="dropdown">
                      ...
                      <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                          >Pages<i class="fa flm fa-angle-down"></i
                        ></a>
                        <ul class="dropdown-menu">
                          <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                              >Blog<i class="fa flm fa-angle-right"></i
                            ></a>
                            <ul class="dropdown-menu">
                          ...
                          <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                              >News Single<i class="fa flm fa-angle-right"></i
                            ></a>
                            <ul class="dropdown-menu">
                          ...
                          <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                              >Contributors<i class="fa flm fa-angle-right"></i
                            ></a>
                            <ul class="dropdown-menu">
                              <li><a href="contributors.html">Contributors 1</a></li>
                              <li>
                                <a href="contributors-2.html">Contributors 2</a>
                              </li>
                              <li>
                                <a href="contributors-3.html">Contributors 3</a>
                              </li>
                              <li>
                                <a href="contributors-4.html">Contributors 4</a>
                              </li>
                            </ul>
                          </li>
                          ...
                          <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                              >Shop<i class="fa flm fa-angle-right"></i
                            ></a>
                            <ul class="dropdown-menu">
                          ...
                          <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                              >Contact<i class="fa flm fa-angle-right"></i
                            ></a>
                            <ul class="dropdown-menu">
            ...
            <div class="main-content--section pbottom--30">
              <div class="container">
                        ...
                        <div class="row gutter--15">
                          <div class="col-xs-6 col-xss-12">
                            <div class="post--item post--layout-1 post--title-large">
                              <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"
                                  ><img src="{{ asset('frontend_assets') }}/img/home-img/banner-02.jpg" alt=""
                                /></a>
                          ...
                          <div class="col-xs-6 hidden-xss">
                            <div class="post--item post--layout-1 post--title-large">
                              <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"
                                  ><img src="{{ asset('frontend_assets') }}/img/home-img/banner-03.jpg" alt=""
                                /></a>
                          ...
                          <div class="col-sm-12 hidden-sm hidden-xs">
                            <div class="post--item post--layout-1 post--title-larger">
                              <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"
                                  ><img src="{{ asset('frontend_assets') }}/img/home-img/banner-04.jpg" alt=""
                                /></a>
                                <a href="#" class="cat">Politics</a>
                                <a href="#" class="icon"
                                  ...
                                  <div class="title">
                                    <h2 class="h4">
                                      <a href="news-single-v1.html" class="btn-link"
                                        ...
                                        beguiled and demoralized by the sure.</a
                                      >
                                    </h2>
                                  </div>
                                </div>
                      ...
                      <div class="row">
                              ...
                              <li class="col-xs-12">
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/world-news-01.jpg"
                                        alt=""
                                    /></a>
                                    ...
                                    <div class="post--info">
                                      ...
                                      <div class="title">
                                        <h3 class="h4">
                                          <a
                                            href="news-single-v1.html"
                                            class="btn-link"
                                            >Siriya attaced by a long established fact
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/world-news-02.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/world-news-03.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/world-news-04.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/world-news-05.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/technology-01.jpg"
                                        alt=""
                                    /></a>
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/technology-02.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/technology-03.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/technology-04.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/technology-05.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                        ...
                        <div class="col-md-12 ptop--30 pbottom--30">
                          <div class="ad--space">
                            <a href="#">
                              <img
                                src="{{ asset('frontend_assets') }}/img/ads-img/ad-728x90-01.jpg"
                                alt=""
                                class="center-block"
                              />
                            </a>
                            ...
                            <ul class="nav row" data-ajax-content="inner">
                              <li class="col-md-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img src="{{ asset('frontend_assets') }}/img/home-img/finance-01.jpg" alt=""
                                    /></a>
                                  ...
                                  <li class="col-xs-6">
                                    <div class="post--item post--layout-2">
                                      <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"
                                          ><img
                                            src="{{ asset('frontend_assets') }}/img/home-img/finance-02.jpg"
                                            alt=""
                                        /></a>
                                        <div class="post--info">
                                          <ul class="nav meta">
                                  ...
                                  <li class="col-xs-6">
                                    <div class="post--item post--layout-2">
                                      <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"
                                          ><img
                                            src="{{ asset('frontend_assets') }}/img/home-img/finance-03.jpg"
                                            alt=""
                                        /></a>
                                        <div class="post--info">
                                          <ul class="nav meta">
                                  ...
                                  <li class="col-xs-6">
                                    <div class="post--item post--layout-2">
                                      <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"
                                          ><img
                                            src="{{ asset('frontend_assets') }}/img/home-img/finance-04.jpg"
                                            alt=""
                                        /></a>
                                        <div class="post--info">
                                          <ul class="nav meta">
                                  ...
                                  <li class="col-xs-6">
                                    <div class="post--item post--layout-2">
                                      <div class="post--img">
                                        <a href="news-single-v1.html" class="thumb"
                                          ><img
                                            src="{{ asset('frontend_assets') }}/img/home-img/finance-05.jpg"
                                            alt=""
                                        /></a>
                                        <div class="post--info">
                                          <ul class="nav meta">
                            ...
                            <ul class="nav row gutter--15" data-ajax-content="inner">
                              <li class="col-xs-12">
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img src="{{ asset('frontend_assets') }}/img/home-img/politics-01.jpg" alt=""
                                    /></a>
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img src="{{ asset('frontend_assets') }}/img/home-img/politics-02.jpg" alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                                        <li><a href="#">Hantu Raya</a></li>
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img src="{{ asset('frontend_assets') }}/img/home-img/politics-03.jpg" alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                                        <li><a href="#">Astaroth</a></li>
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img src="{{ asset('frontend_assets') }}/img/home-img/politics-04.jpg" alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                                        <li><a href="#">Astaroth</a></li>
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img src="{{ asset('frontend_assets') }}/img/home-img/politics-05.jpg" alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                                        <li><a href="#">Hantu Raya</a></li>
                          ...
                          <div class="post--items-title" data-ajax="tab">
                            ...
                            <div class="nav">
                              <a
                                href="#"
                                class="prev btn-link"
                                data-ajax-action="load_prev_sports_posts"
                              >
                                <i class="fa fa-long-arrow-left"></i>
                              </a>
                              <span class="divider">/</span>
                              <a
                                href="#"
                                class="next btn-link"
                                data-ajax-action="load_next_sports_posts"
                              >
                                <i class="fa fa-long-arrow-right"></i>
                              </a>
                            </div>
                            ...
                            <ul class="nav" data-ajax-content="inner">
                              <li>
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img src="{{ asset('frontend_assets') }}/img/home-img/sports-01.jpg" alt=""
                                    /></a>
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img src="{{ asset('frontend_assets') }}/img/home-img/sports-02.jpg" alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                                        <li><a href="#">Bune</a></li>
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img src="{{ asset('frontend_assets') }}/img/home-img/sports-03.jpg" alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                                        <li><a href="#">Bune</a></li>
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img src="{{ asset('frontend_assets') }}/img/home-img/sports-04.jpg" alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                                        <li><a href="#">Bune</a></li>
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img src="{{ asset('frontend_assets') }}/img/home-img/sports-05.jpg" alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                                        <li><a href="#">Bune</a></li>
                  ...
                  >
                    <div class="sticky-content-inner">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/widgets-img/news-widget-01.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/widgets-img/news-widget-02.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/widgets-img/news-widget-03.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/widgets-img/news-widget-04.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                      ...
                      <div class="widget">
                        ...
                        <div class="ad--widget">
                          <a href="#">
                            <img src="{{ asset('frontend_assets') }}/img/ads-img/ad-300x250-2.jpg" alt="" />
                          </a>
                        </div>
                      </div>
                    </div>
                ...
                <div class="main--content pd--30-0">
                  <div class="post--items-title" data-ajax="tab">
                    ...
                    <div class="nav">
                      <a
                        href="#"
                        class="prev btn-link"
                        data-ajax-action="load_prev_audio_video_posts"
                      >
                        <i class="fa fa-long-arrow-left"></i>
                      </a>
                      <span class="divider">/</span>
                      <a
                        href="#"
                        class="next btn-link"
                        data-ajax-action="load_next_audio_video_posts"
                      >
                        <i class="fa fa-long-arrow-right"></i>
                      </a>
                    </div>
                  ...
                  <div class="post--items post--items-4" data-ajax-content="outer">
                    <ul class="nav row" data-ajax-content="inner">
                      <li class="col-md-8">
                        <div
                          class="post--item post--layout-1 post--type-video post--title-large"
                        >
                          <div class="post--img">
                            <a href="news-single-v1.html" class="thumb"
                              ><img src="{{ asset('frontend_assets') }}/img/home-img/audio-video-01.jpg" alt=""
                            /></a>
                        ...
                        <ul class="nav">
                          <li>
                            <div class="post--item post--type-audio post--layout-3">
                              <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"
                                  ><img src="{{ asset('frontend_assets') }}/img/home-img/audio-video-02.jpg" alt=""
                                /></a>
                                <div class="post--info">
                                  <ul class="nav meta">
                          ...
                          <li>
                            <div class="post--item post--type-video post--layout-3">
                              <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"
                                  ><img src="{{ asset('frontend_assets') }}/img/home-img/audio-video-03.jpg" alt=""
                                /></a>
                                <div class="post--info">
                                  <ul class="nav meta">
                                    <li><a href="#">Maclaan John</a></li>
                          ...
                          <li>
                            <div class="post--item post--type-video post--layout-3">
                              <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"
                                  ><img src="{{ asset('frontend_assets') }}/img/home-img/audio-video-04.jpg" alt=""
                                /></a>
                                <div class="post--info">
                                  <ul class="nav meta">
                                    <li><a href="#">Maclaan John</a></li>
                          ...
                          <li>
                            <div class="post--item post--type-audio post--layout-3">
                              <div class="post--img">
                                <a href="news-single-v1.html" class="thumb"
                                  ><img src="{{ asset('frontend_assets') }}/img/home-img/audio-video-05.jpg" alt=""
                                /></a>
                                <div class="post--info">
                                  <ul class="nav meta">
                                    <li><a href="#">Maclaan John</a></li>
                ...
                <div class="ad--space pd--30-0">
                  <a href="#">
                    <img
                      src="{{ asset('frontend_assets') }}/img/ads-img/ad-970x90.jpg"
                      alt=""
                      class="center-block"
                    />
                  </a>
                              ...
                              <li>
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/health-and-fitness-01.jpg"
                                        alt=""
                                    /></a>
                                    <a href="#" class="cat">Business</a>
                                    <a href="#" class="icon"
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/health-and-fitness-02.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/health-and-fitness-03.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/health-and-fitness-04.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/health-and-fitness-05.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-xs-12">
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/lifestyle-01.jpg"
                                        alt=""
                                    /></a>
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/lifestyle-02.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/lifestyle-03.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/lifestyle-04.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-xs-6">
                                <div class="post--item post--layout-2">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/lifestyle-05.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-md-4 col-xs-6 col-xxs-12">
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/food-and-resturent-01.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-md-4 col-xs-6 col-xxs-12">
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/food-and-resturent-02.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-md-4 hidden-sm hidden-xs">
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/food-and-resturent-03.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-md-12">
                                ...
                                >
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/photo-gallery-01.jpg"
                                        alt=""
                                    /></a>
                              ...
                              <li class="col-md-4 col-xs-6 col-xxs-12">
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/photo-gallery-02.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-md-4 col-xs-6 col-xxs-12">
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/photo-gallery-03.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li class="col-md-4 hidden-sm hidden-xs">
                                <div class="post--item post--layout-1">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/home-img/photo-gallery-04.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                  ...
                  >
                    <div class="sticky-content-inner">
                      ...
                      <div class="widget">
                        <div class="ad--widget">
                          <div class="row">
                            <div class="col-sm-6">
                              <a href="#">
                                <img src="{{ asset('frontend_assets') }}/img/ads-img/ad-150x150-1.jpg" alt="" />
                              </a>
                            </div>
                            <div class="col-sm-6">
                              <a href="#">
                                <img src="{{ asset('frontend_assets') }}/img/ads-img/ad-150x150-2.jpg" alt="" />
                              </a>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="widget">
                        ...
                        <div
                          class="list--widget list--widget-2"
                          data-ajax-content="outer"
                        >
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <span class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/widgets-img/readers-opinion-01.png"
                                        alt=""
                                    /></span>
                                    <div class="post--info">
                                      <div class="title">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <span class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/widgets-img/readers-opinion-02.png"
                                        alt=""
                                    /></span>
                                    <div class="post--info">
                                      <div class="title">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <span class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/widgets-img/readers-opinion-03.png"
                                        alt=""
                                    /></span>
                                    <div class="post--info">
                                      <div class="title">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/widgets-img/editors-choice-01.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/widgets-img/editors-choice-02.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/widgets-img/editors-choice-03.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                              ...
                              <li>
                                <div class="post--item post--layout-3">
                                  <div class="post--img">
                                    <a href="news-single-v1.html" class="thumb"
                                      ><img
                                        src="{{ asset('frontend_assets') }}/img/widgets-img/editors-choice-04.jpg"
                                        alt=""
                                    /></a>
                                    <div class="post--info">
                                      <ul class="nav meta">
                        ...
                        <div class="about--widget">
                          ...
                          <div class="action">
                            <a href="#" class="btn-link"
                              >Read More<i class="fa flm fa-angle-double-right"></i
                            ></a>
                          </div>
                          <ul class="nav">
                            <li>
