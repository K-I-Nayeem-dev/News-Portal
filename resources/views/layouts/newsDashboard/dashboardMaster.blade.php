    ...
    <div id="main-wrapper">
        ...
        <div><!-- ---------------------------------- -->
            ...
            <div class="user-profile position-relative" style="background: url({{ asset('dashboard_assets') }}/images/backgrounds/user-info.jpg) no-repeat;">
                ...
                <a href="javascript:void(0)" class="dropdown-toggle u-dropdown w-100 text-white d-block position-relative id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">{{ auth()->user()->name }}</a>
                    ...
                    <div class="dropdown-divider ms-2"></div>
                        <div class="d-flex align-items-center ms-3">
                            ...
                            <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                @csrf
                                    <button style="background-color: transparent; border: none;" href="{{ route('logout') }}" class="text-danger btn btn-danger ms-1 btn-sm">Log Out</button>
                            </form>
                        </div>
                    <div class="dropdown-divider"></div>
