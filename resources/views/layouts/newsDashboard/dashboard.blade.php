...
<head>
    ...
    <div id="main-wrapper">
        ...
        <div><!-- ---------------------------------- -->
            ...
            <!-----------Profile------------------>
            <div class="user-profile position-relative" style="background: url({{ asset('dashboard_assets') }}/images/backgrounds/user-info.jpg) no-repeat;">
                <!-- User profile image -->
                <div class="profile-img">
                <img src="{{ asset('dashboard_assets') }}/images/profile/user-1.jpg" alt="user" class="w-100 rounded-circle overflow-hidden">
                </div>
                <!-- User profile text-->
                ...
                <div class="dropdown-menu animated flipInY" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item d-flex gap-2" href="page-user-profile.html"> <i data-feather="user" class="feather-sm text-info "></i> My Profile </a>
                    <a class="dropdown-item d-flex gap-2" href="app-notes.html"> <i data-feather="credit-card" class="feather-sm text-info "></i> My Notes </a>
                    <a class="dropdown-item d-flex gap-2" href="app-email.html"> <i data-feather="mail" class="feather-sm text-success "></i> Inbox </a>

                    <div class="dropdown-divider"></div>
                        <a class="dropdown-item d-flex gap-2" href="page-account-settings.html"> <i data-feather="settings" class="feather-sm text-warning "></i> Account Setting </a>
                    <div class="d-flex align-items-center dropdown-divider ms-2"></div>
                        <i data-feather="log-out" class="feather-sm text-danger"></i>
                        <form id="logout-form" action="{{ route('logout') }}" method="POST">
                            @csrf
                                <button href="{{ route('logout') }}" class="text-white btn btn-danger">Log Out</button>
                        </form>
                    <div class="dropdown-divider"></div>
            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                <a class="sidebar-link" href="index3.html">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                    <li class="sidebar-item">
                    <a href="frontend-landingpage.html" class="sidebar-link sublink">
                    ...
                    <li class="sidebar-item">
                    <a href="frontend-aboutpage.html" class="sidebar-link sublink">
                        <div class="round-16 d-flex align-items-center justify-content-center">
                        <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                        </div>
                    ...
                    <li class="sidebar-item">
                    <a href="frontend-blogpage.html" class="sidebar-link sublink">
                        <div class="round-16 d-flex align-items-center justify-content-center">
                        <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                        </div>
                    ...
                    <li class="sidebar-item">
                    <a href="frontend-blogdetailpage.html" class="sidebar-link sublink">
                        <div class="round-16 d-flex align-items-center justify-content-center">
                        <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                        </div>
                    ...
                    <li class="sidebar-item">
                    <a href="frontend-contactpage.html" class="sidebar-link sublink">
                        <div class="round-16 d-flex align-items-center justify-content-center">
                        <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                        </div>
                    ...
                    <li class="sidebar-item">
                    <a href="frontend-portfoliopage.html" class="sidebar-link sublink">
                        <div class="round-16 d-flex align-items-center justify-content-center">
                        <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                        </div>
                    ...
                    <li class="sidebar-item">
                    <a href="frontend-pricingpage.html" class="sidebar-link sublink">
                        <div class="round-16 d-flex align-items-center justify-content-center">
                        <iconify-icon icon="solar:stop-circle-line-duotone"></iconify-icon>
                        </div>
                ...
                <li class="sidebar-item">
                <a class="sidebar-link" href="page-faq.html">
                    <iconify-icon icon="solar:question-circle-linear" class="aside-icon"></iconify-icon>
                    <span class="hide-menu">FAQ</span>
                </a>
                </li>
                <li class="sidebar-item">
                <a class="sidebar-link" href="page-account-settings.html">
                    <iconify-icon icon="solar:user-circle-linear" class="aside-icon"></iconify-icon>
                ...
                <li class="sidebar-item">
                <a class="sidebar-link" href="icon-tabler.html">
                    <iconify-icon icon="solar:ghost-smile-linear" class="aside-icon"></iconify-icon>
                    <span class="hide-menu">Tabler Icon</span>
                </a>
                </li>
                <li class="sidebar-item">
                <a class="sidebar-link" href="icon-solar.html">
                ...
                <li class="sidebar-item">
                <a class="sidebar-link" href="authentication-error.html">
                    <iconify-icon icon="solar:shield-warning-linear" class="aside-icon"></iconify-icon>
                ...
                <li class="sidebar-item">
                <a class="sidebar-link" href="../docs/index.html">
                    <iconify-icon icon="solar:shield-warning-linear" class="aside-icon"></iconify-icon>
        ...
        <header class="topbar rounded-0 border-0 bg-primary">
            ...
            <nav class="navbar navbar-expand-lg px-lg-0 px-3 py-0">
                ...
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    ...
                    <b class="logo-icon">
                        ...
                        <!-- Dark Logo icon -->
                        <img src="{{ asset('dashboard_assets') }}/images/logos/logo-light-icon.svg" alt="homepage" class="dark-logo">
                        <!-- Light Logo icon -->
                        <img src="{{ asset('dashboard_assets') }}/images/logos/logo-light-icon.svg" alt="homepage" class="light-logo">
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span class="logo-text">
                        <!-- dark Logo text -->
                        <img src="{{ asset('dashboard_assets') }}/images/logos/logo-light-text.svg" alt="homepage" class="dark-logo ps-2">
                        <!-- Light Logo text -->
                        <img src="{{ asset('dashboard_assets') }}/images/logos/logo-light-text.svg" class="light-logo ps-2" alt="homepage">
                    </span>
                    </a>
                </div>
                </div>
                ...
                <li class="nav-item d-none d-lg-block dropdown nav-icon-hover-bg rounded-circle">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="ps-3 pt-3">
                            ...
                            <div class="col-8">
                                <a class="text-dark d-flex align-items-center lh-1 fs-3 bg-hover-primary" href="page-faq.html">
                        ...
                        <div class="position-relative p-3 border-start h-100">
                            ...
                            <ul>
                            <li class="mb-3">
                                <a class="text-dark bg-hover-primary" href="page-pricing.html">Pricing Page</a>
                            </li>
                            <li class="mb-3">
                                <a class="text-dark bg-hover-primary" href="authentication-login.html">Authentication Design</a>
                            </li>
                            <li class="mb-3">
                                <a class="text-dark bg-hover-primary" href="authentication-register.html">Register Now</a>
                            </li>
                            <li class="mb-3">
                                <a class="text-dark bg-hover-primary" href="authentication-error.html">404 Error Page</a>
                            </li>
                            <li class="mb-3">
                                <a class="text-dark bg-hover-primary" href="app-notes.html">Notes App</a>
                            </li>
                            <li class="mb-3">
                                <a class="text-dark bg-hover-primary" href="page-user-profile.html">User Application</a>
                            </li>
                            <li class="mb-3">
                                <a class="text-dark bg-hover-primary" href="page-account-settings.html">Account Settings</a>
                            </li>
                            </ul>
                        </div>
                        </div>
                ...
                <div class="d-flex align-items-center justify-content-between py-2 py-lg-0">
                    ...
                    <li class="nav-item hover-dd dropdown nav-icon-hover-bg rounded-circle">
                        ...
                        <div class="message-body" data-simplebar="">
                            ...
                            <span class="user-img position-relative d-inline-block">
                                <img src="{{ asset('dashboard_assets') }}/images/profile/user-2.jpg" alt="user" class="rounded-circle w-100 round-40">
                            ...
                            <a href="javascript:void(0)" class="p-3 d-flex align-items-center dropdown-item gap-3 border-bottom">
                            <span class="user-img position-relative d-inline-block">
                                <img src="{{ asset('dashboard_assets') }}/images/profile/user-3.jpg" alt="user" class="rounded-circle w-100 round-40">
                                <span class="profile-status bg-success position-absolute rounded-circle"></span>
                            </span>
                            <div class="w-80">
                                <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="javascript:void(0)" class="p-3 d-flex align-items-center dropdown-item gap-3 border-bottom">
                            <span class="user-img position-relative d-inline-block">
                                <img src="{{ asset('dashboard_assets') }}/images/profile/user-4.jpg" alt="user" class="rounded-circle w-100 round-40">
                                <span class="profile-status bg-success position-absolute rounded-circle"></span>
                            </span>
                            <div class="w-80">
                                <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="javascript:void(0)" class="p-3 d-flex align-items-center dropdown-item gap-3 border-bottom">
                            <span class="user-img position-relative d-inline-block">
                                <img src="{{ asset('dashboard_assets') }}/images/profile/user-5.jpg" alt="user" class="rounded-circle w-100 round-40">
                                <span class="profile-status bg-success position-absolute rounded-circle"></span>
                            </span>
                            <div class="w-80">
                                <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="javascript:void(0)" class="p-3 d-flex align-items-center dropdown-item gap-3 border-bottom">
                            <span class="user-img position-relative d-inline-block">
                                <img src="{{ asset('dashboard_assets') }}/images/profile/user-6.jpg" alt="user" class="rounded-circle w-100 round-40">
                                <span class="profile-status bg-success position-absolute rounded-circle"></span>
                            </span>
                            <div class="w-80">
                                <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="javascript:void(0)" class="p-3 d-flex align-items-center dropdown-item gap-3 border-bottom">
                            <span class="user-img position-relative d-inline-block">
                                <img src="{{ asset('dashboard_assets') }}/images/profile/user-7.jpg" alt="user" class="rounded-circle w-100 round-40">
                                <span class="profile-status bg-success position-absolute rounded-circle"></span>
                            </span>
                            <div class="w-80">
                                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <li class="nav-item hover-dd dropdown nav-icon-hover-bg rounded-circle">
                        ...
                        <img src="{{ asset('dashboard_assets') }}/images/svgs/icon-flag-en.svg" alt="" width="20px" height="20px" class="round-20">
                        </a>
                        ...
                        <div class="message-body">
                            ...
                            <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-2 px-4 dropdown-item">
                            <div class="position-relative">
                                <img src="{{ asset('dashboard_assets') }}/images/svgs/icon-flag-cn.svg" alt="" width="20px" height="20px" class="round-20">
                            </div>
                            <p class="mb-0 fs-3">Chinese</p>
                            </a>
                            <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-2 px-4 dropdown-item">
                            <div class="position-relative">
                                <img src="{{ asset('dashboard_assets') }}/images/svgs/icon-flag-fr.svg" alt="" width="20px" height="20px" class="round-20">
                            </div>
                            <p class="mb-0 fs-3">French</p>
                            </a>
                            <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-2 px-4 dropdown-item">
                            <div class="position-relative">
                                <img src="{{ asset('dashboard_assets') }}/images/svgs/icon-flag-sa.svg" alt="" width="20px" height="20px" class="round-20">
                            </div>
                    ...
                    <li class="nav-item hover-dd dropdown">
                        <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" aria-expanded="false">
                        <img src="{{ asset('dashboard_assets') }}/images/profile/user-1.jpg" alt="user" class="profile-pic rounded-circle round-30">
                        </a>
                        ...
                        <div class="profile-dropdown position-relative" data-simplebar="">
                            ...
                            <div class="d-flex align-items-center px-3">
                                <img src="{{ asset('dashboard_assets') }}/images/profile/user-1.jpg" class="rounded-circle round-50" alt="">
                                <div class="ms-3">
                            ...
                            <div class="px-3">
                                ...
                                <div class="h6 mb-0 dropdown-item py-8 px-3 rounded-2 link">
                                <a href="page-account-settings.html" class=" d-flex  align-items-center  ">
                                    Account Settings
                                </a>
                                </div>
                                <div class="mt-2 ms-2">
            ...
            <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="mobilenavbar" aria-labelledby="offcanvasWithBothOptionsLabel">
                ...
                <div class="offcanvas-header justify-content-between">
                    ...
                    <span class="logo-text">
                        <!-- dark Logo text -->
                        <img src="{{ asset('dashboard_assets') }}/images/logos/logo-text.svg" alt="homepage" class="dark-logo ps-2">
                        <!-- Light Logo text -->
                        <img src="{{ asset('dashboard_assets') }}/images/logos/logo-light-text.svg" class="light-logo ps-2" alt="homepage">
                    </span>
                    </a>
                ...
                <div class="offcanvas-body h-n80" data-simplebar="">
                    ...
                    <li class="sidebar-item">
                        ...
                        <li class="sidebar-item py-2">
                            <a href="app-chat.html" class="d-flex align-items-center position-relative ">
                            <div class="bg-primary-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                <iconify-icon icon="solar:chat-line-linear" class="text-primary fs-5"></iconify-icon>
                            </div>
                            <div class="d-inline-block ">
                        ...
                        <li class="sidebar-item py-2">
                            <a href="app-invoice.html" class="d-flex align-items-center position-relative">
                            <div class="bg-secondary-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                <iconify-icon icon="solar:bill-list-linear" class="text-secondary fs-5"></iconify-icon>
                            </div>
                            <div class="d-inline-block">
                        ...
                        <li class="sidebar-item py-2">
                            <a href="app-contact2.html" class="d-flex align-items-center position-relative">
                            <div class="bg-success-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                <iconify-icon icon="solar:bedside-table-2-linear" class="text-success fs-5"></iconify-icon>
                            </div>
                            <div class="d-inline-block">
                        ...
                        <li class="sidebar-item py-2">
                            <a href="page-user-profile.html" class="d-flex align-items-center position-relative">
                            <div class="bg-danger-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                <iconify-icon icon="solar:cart-large-2-linear" class="text-danger fs-5"></iconify-icon>
                            </div>
                            <div class="d-inline-block">
                        ...
                        <li class="sidebar-item py-2">
                            <a href="app-calendar.html" class="d-flex align-items-center position-relative">
                            <div class="bg-primary-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                <iconify-icon icon="solar:calendar-linear" class="text-primary fs-5"></iconify-icon>
                            </div>
                            <div class="d-inline-block">
                        ...
                        <li class="sidebar-item py-2">
                            <a href="app-contact.html" class="d-flex align-items-center position-relative">
                            <div class="bg-secondary-subtle rounded-circle round-40 me-3 p-6 d-flex align-items-center justify-content-center">
                                <iconify-icon icon="solar:bedside-table-linear" class="text-secondary fs-5"></iconify-icon>
                            </div>
                            <div class="d-inline-block">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link px-1" href="app-chat.html" aria-expanded="false">
                        <span class="d-flex">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link px-1" href="app-calendar.html" aria-expanded="false">
                        <span class="d-flex">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link px-1" href="app-email.html" aria-expanded="false">
                        <span class="d-flex">
            ...
            <nav class="navbar navbar-expand-xl container-fluid">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <li class="nav-item hover-dd dropdown">
                        <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" aria-expanded="false">
                        <img src="{{ asset('dashboard_assets') }}/images/profile/user-1.jpg" alt="user" width="30" class="profile-pic rounded-circle">
                        </a>
                        <div class="dropdown-menu pt-0 content-dd overflow-hidden pt-0 dropdown-menu-end user-dd" aria-labelledby="drop2">
                        <div class="profile-dropdown position-relative" data-simplebar="">
                            <div class=" py-3 border-bottom">
                            ...
                            <div class="px-3">
                                ...
                                <div class="h6 mb-0 dropdown-item py-8 px-3 rounded-2 link">
                                <a href="authentication-login.html" class=" d-flex  align-items-center ">
                                    Sign Out
                                </a>
                                </div>
                            </div>
        ...
        <aside class="left-sidebar with-horizontal">
            ...
            <nav id="sidebarnavh" class="sidebar-nav scroll-sidebar container-fluid">
                ...
                <!-- ============================= -->
                <li class="nav-small-cap">
                    <iconify-icon icon="solar:document-text-line-duotone" class="nav-small-cap-icon"></iconify-icon>
                    <span class="hide-menu">Front Pages</span>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
            ...
            <div class="row">
                ...
                <div class="card blog-widget w-100">
                    ...
                    <div class="blog-image">
                        <img src="{{ asset('dashboard_assets') }}/images/backgrounds/blog-bg.jpg" height="273" alt="img" class="w-100 rounded">
                    </div>
                    <div class="p-9">
                        <div class="
                        badge badge-pill
                ...
                <div class="card">
                    <div class="card-body p-2">
                    <img class="card-img-top w-100 profile-bg-height rounded overflow-hidden" src="{{ asset('dashboard_assets') }}/images/backgrounds/profile-bg.jpg" height="111" alt="Card image cap">
                    <div class="card-body little-profile text-center p-9">
                        <div class="pro-img">
                        <img src="{{ asset('dashboard_assets') }}/images/profile/user-2.jpg" alt="user" class="rounded-circle shadow-sm" width="112">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="message-widget contact-widget position-relative">
                        ...
                        <div class="user-img position-relative">
                            <img src="{{ asset('dashboard_assets') }}/images/profile/user-2.jpg" alt="user" class="rounded-circle w-100">
                            <span class="
                                profile-status
                                pull-right
                                d-inline-block
                        ...
                        <a href="javascript:void(0)" class="py-4 hstack px-7 gap-3">
                        <div class="user-img position-relative">
                            <img src="{{ asset('dashboard_assets') }}/images/profile/user-6.jpg" alt="user" class="rounded-circle w-100">
                            <span class="
                                profile-status
                                pull-right
                                d-inline-block
                        ...
                        <div class="user-img position-relative">
                            <img src="{{ asset('dashboard_assets') }}/images/profile/user-3.jpg" alt="user" class="rounded-circle w-100">
                            <span class="
                                profile-status
                                pull-right
                                d-inline-block
                    ...
                    <div class="tab-content">
                        ...
                        <div class="profiletimeline position-relative">
                            ...
                            <div class="sl-left float-left me-4">
                                <img src="{{ asset('dashboard_assets') }}/images/profile/user-4.jpg" alt="user" class="rounded-circle">
                            </div>
                            <div class="sl-right w-100">
                                ...
                                <div class="row gx-9">
                                    ...
                                    <img src="{{ asset('dashboard_assets') }}/images/blog/blog-img1.jpg" alt="user" class="rounded-1 w-100" height="80">
                                    </div>
                                    <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                                    <img src="{{ asset('dashboard_assets') }}/images/blog/blog-img2.jpg" alt="user" class="rounded-1 w-100" height="80">
                                    </div>
                                    <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                                    <img src="{{ asset('dashboard_assets') }}/images/blog/blog-img3.jpg" alt="user" class="rounded-1 w-100" height="80">
                                    </div>
                                    <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                                    <img src="{{ asset('dashboard_assets') }}/images/blog/blog-img4.jpg" alt="user" class="rounded-1 w-100" height="80">
                                    </div>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="sl-left float-left me-4">
                                <img src="{{ asset('dashboard_assets') }}/images/profile/user-5.jpg" alt="user" class="rounded-circle">
                            </div>
                            <div class="sl-right w-100">
                                <div>
                                <div class="d-md-flex align-items-center justify-content-between gap-6 mb-6">
                            ...
                            <div class="sl-left float-left me-4">
                                <img src="{{ asset('dashboard_assets') }}/images/profile/user-6.jpg" alt="user" class="rounded-circle">
                            </div>
                            <div class="sl-right w-100">
                                <div>
                                <div class="d-md-flex align-items-center justify-content-between gap-6 mb-6">
                                ...
                                <div class="row gx-9 mb-9">
                                    ...
                                    <div class="hstack gap-3 border rounded-2 px-7 py-9">
                                        <img src="{{ asset('dashboard_assets') }}/images/svgs/icon-zip.svg" alt="user" class="img-fluid flex-shrink-0">
                                        <div>
                                        <h5>Payments.zip</h5>
                                    ...
                                    <div class="col-lg-5">
                                    <div class="hstack gap-3 border rounded-2 px-7 py-9">
                                        <img src="{{ asset('dashboard_assets') }}/images/svgs/icon-figma2.svg" alt="user" class="img-fluid flex-shrink-0">
                                        <div>
                                        <h5>Payments.zip</h5>
                                        <p class="mb-0 fs-3">150kb</p>
                                        </div>
