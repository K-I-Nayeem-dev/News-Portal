                    ...
                    <div class="card">
                        ...
                        <h5 class="card-header text-white d-flex justify-content-between" style="background-color: #1B84FF">
                            ...
                            <span>
                                ...
                                <a class="text-white" href="{{ route('dashboard_news.index') }}">Back</a>

                                <a class="text-white ms-2" href="{{ route('dashboard_news.edit', $news->id) }}">Edit</a>
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <p class="mb-2" style="font-size: 24px; border-bottom: 2px #768B9E solid;  display: inline-block; margin-bottom: 5px">{{ $news->newsCategory->category_bn }}</p>

                                <h1 class="mb-2">{{ $news->title_bn }}</h1>
                                ...
                                <p class="d-flex align-items-center">
                                    ...
                                    <span class="ms-2">
                                        <span>{{ $news->newsDistrict->district_bn }} - {{ $news->newsSubDist->sub_district_bn }}</span>
                                    </span>
                            ...
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-primary rounded" href="{{ route('dashboard_news.index') }}">Back</a>
                            </div>
